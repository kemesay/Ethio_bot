...
TOKEN = '5632692363:AAGQ6rLTHNrxYHLMZKVuR2l7QSS6AoNZMko'
...
list_of_Destinations = [
    ...
    {'latitude': 14.130324044204388, 'longitude': 38.71960239635018},
    {'latitude': 12.671834854821704, 'longitude': 41.368412757590484},
    {'latitude': 9.057043029410826, 'longitude': 38.7391347693207},
...
otc = [
    {'latitude': 8.993366634288531, 'longitude': 38.78174175527754},
   
      ]

hotels = [
    
    {'latitude': .992458888128674, 'longitude': 38.78167913863494},
    {'latitude': 8.992148586528081, 'longitude': 38.78273911608953},
...
banks = [
    {'latitude': 8.991505161039433, 'longitude': 38.78261286322701},
    {'latitude': 8.99011639341585, 'longitude': 38.78630946747074},
    {'latitude': 8.991966221727765, 'longitude': 38.781470017198636},
...
def send_rate_to_api(rate, userId, username):
    api_url = 'http://localhost:9010/api/rate/push'
    data = {
        'rate': rate,
        'userId': userId,
        'username': username
...
def start(update: Update, context: CallbackContext):
    ...
    print(username)
    context.bot.send_photo(chat_id=update.effective_user.id, photo=open("origin.jpg", "rb"),
                           caption="ETHIOPIA!")
    context.bot.send_message(chat_id=update.effective_user.id,
                             text=f"Hello Mr/Mrs. {update.effective_user.first_name} \n WelCome to LAND OF ORIGIN!!")
...
def main():
    updater = Updater(token="5632692363:AAGQ6rLTHNrxYHLMZKVuR2l7QSS6AoNZMko", use_context=True)
